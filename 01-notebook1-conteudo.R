...
# Notebook 1: Economia, análise de dados e ambiente R
# ============================================================
#
# ============================================================ 
...
#
# Comparando base R vs tidyverse para calcular o IPCA acumulado:
# Base R
inflacao_exemplo$ipca_acum <- cumsum(inflacao_exemplo$ipca)
inflacao_exemplo
#
# Tidyverse: encadeia operações com o pipe, sem objetos intermediários
inflacao_exemplo |>
  mutate(ipca_acum = cumsum(ipca))
# O resultado é o mesmo, mas a sintaxe do tidyverse é mais fluida e legível, especialmente para operações mais complexas.
#
...
ggsave("notebook1_mini_ipca.png", p1, width = 7, height = 4)

# CHECKPOINT:
# 1) troque o gráfico para y = cambio
# 2) salve como notebook1_mini_cambio.png
...
#Salvar o gráfico:
ggsave("notebook1_ipca_1994_2018.png", grafico2, width = 8, height = 4)
#
#
